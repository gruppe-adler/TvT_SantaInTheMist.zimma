...
_caller setVariable ["mitm_selectedWeaponOnAnimation", currentWeapon _caller];
...
if (vehicle _caller == _caller && {_callerAnim != ""}) then {
    ...
    if (stance _caller == "STAND") then {
        _caller setVariable ["mitm_prevAnimCaller", "amovpknlmstpsraswrfldnon"];
    } else {
        _caller setVariable ["mitm_prevAnimCaller", animationState _caller];
    };
